...
# keystoneauth Release Notes documentation build configuration file, created
...
import pbr.version
keystone_version = pbr.version.VersionInfo('keystoneauth')
...
htmlhelp_basename = 'keystoneauthReleaseNotesdoc'
